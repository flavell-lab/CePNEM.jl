...
output_path_gt = "/om2/user/aaatanas/gen_sbc_nl9/h5/$(ARGS[1])_gt.h5"
# output_path_smc5000_1 = "/om2/user/aaatanas/gen_sbc_nl9/h5/$(ARGS[1])_smc5000_1.h5"
output_path_smc5000_2 = "/om2/user/aaatanas/gen_sbc_nl9/h5/$(ARGS[1])_smc5000_2.h5"
...
(trace, _) = Gen.generate(nl9, (n_obs, v, θh, P))
...
output_state(state, output_path_smc5000_2, 4095, model)
